...
- Turn in your keys and your laptop to your supervisor or HR when you leave Fibroblast
...
- Do not use dictionary words (e.g., Fibroblast, password123).
...
- Store confidential information such as PHI only on Fibroblast’s secured network severs. Never store PHI on a laptop or other portable, endpoint device.
...
**Violating Fibroblast policies, federal regulations, and state laws and regulations can lead to disciplinary action – up to and including termination, personal fines, civil and criminal penalties and suspension of professional licenses.**
